        ...
        <div class="top-cont clear">
            <div class="navi">
                <ul>
                    ...
                    <li><a href="#" title="IT 자산실사">IT 자산실사</a></li>
                    <li><a href="#" title="IT자산실사 현황">IT자산실사 현황</a></li>
                </ul>
            </div>
		...
		<script>      
			$("#Grid").kendoGrid({
				columns: [
				  ...
				  dataSource: {
				   data: [
				    { id: 1, 자산번호: "NOTEBOOK_0102030", 제품명: "노트북", 도입일자: "2018-12-20", 사원번호: "HCNC_002MK", 이름: "홍길동", 직위: "사원", 부서: "근로복지부 인사과", 실사: "Y" },
				  	 ],
				   schema:{
				    model: {
				     id: "id",
