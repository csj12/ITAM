	 ...
	 <div class="sub-container">
        ...
        <div class="tab-cont">
            <ul>
                ...
                <li class="on"><a href="#" title="S/W 자산관리">S/W 자산관리</a></li>
                ...
                <div class="section-box">
                    <table class="table-type03">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th><label for="">Version</label></th>
                                <td>
                                    <input type="text" name="" id="" class="">
                                    <label for="" class="hide">Version</label>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="" id="" class="">
                                    <label for="" class="hide">Description</label>
                                </td>
                            </tr>
                            <tr>
                                <th><label for="">License</label></th>
                                <td>
                                    <input type="text" name="" id="" class="">
                                    <label for="" class="hide">License</label>
                                </td>
                            </tr>
                            <tr>
                                <th><label for="">Host Name</label></th>
                                <td>
                                    <input type="text" name="" id="" class="">
                                    <label for="" class="hide">Host Name</label>
                                </td>
                            </tr>
                            <tr>
                                <th><label for="">Mac address</label></th>
                                <td>
                                    <input type="text" name="" id="" class="">
                                    <label for="" class="hide">Mac address</label>
                                </td>
                            </tr>
                            <tr>
                                <th><label for="">설치 자산</label></th>
                                <td>
                                    <input type="text" name="" id="" class="">
                                    <label for="" class="hide">설치 자산</label>
                                </td>
                            </tr>
                        </tbody>
                    </table>
