	 ...
	 <div class="sub-container">
        <div class="top-cont clear">
            <div class="navi">
                <ul>
                    ...
                    <li><a href="#" title="통신설비 자산관리">통신설비 자산관리</a></li>
                </ul>
            </div>
        ...
        <div class="tab-cont">
            <ul>
                ...
                <li class="on"><a href="#" title="통신설비">통신설비</a></li>
                ...
                <div class="section-box">
                    <table class="table-type03">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th><label for="">성능</label></th>
                                <td>
                                    <input type="text" name="" id="" class="">
                                    <label for="" class="hide">성능</label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th><label for="">NIC 카드</label></th>
                                <td>
                                    <input type="text" name="" id="" class="">
                                    <label for="" class="hide">NIC 카드</label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th><label for="">Disk 용량/개수</label></th>
                                <td>
                                    <input type="text" name="" id="" class="">
