...
<title>assets_due_diligence</title>
</head>
<body>
		...
		<div class="top-cont clear">
	            <div class="navi">
	                <ul>
	                    ...
	                    <li><a href="#" title="IT자산실사">IT자산 실사</a></li>
	                    <li><a href="#" title="IT자산실사 현황">IT자산실사 등록</a></li>
	                </ul>
	            </div>
				...
				<caption>자산 정보 테이블</caption>
					...
					<tbody>
						<tr>
							<th>자산번호</th>
							<td>
								<input class="wp70" type="text" > <button type="button" name="" id="" class="btn-search">자산번호 검색</button>
								<label for="" class="hide">자산번호 검색</label>
							</td>
							<th>년도</th>
							<td>
								<input class="wp90" type="text" name="" id="">
								<label for="" class="hide">년도</label>
							</td>
						</tr>
						<tr>
							<th>시리얼 번호</th>
